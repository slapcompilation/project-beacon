<!-- source: https://supabase.com/docs/guides/queues/expose-self-hosted-queues · mirrored 2026-08-13 from Supabase docs -->
...
Note: You only need to expose the `pgmq_public` schema manually when running Supabase locally with the Supabase CLI or self-hosting using Docker Compose.
