<!-- source: https://supabase.com/docs/guides/functions/examples/elevenlabs-transcribe-speech · mirrored 2026-08-13 from Supabase docs -->
...
Note: Find the [example project on GitHub](https://github.com/elevenlabs/elevenlabs-examples/tree/main/examples/speech-to-text/telegram-transcription-bot).
