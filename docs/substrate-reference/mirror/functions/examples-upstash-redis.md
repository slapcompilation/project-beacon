<!-- source: https://supabase.com/docs/guides/functions/examples/upstash-redis · mirrored 2026-08-13 from Supabase docs -->
...
Make sure you have the latest version of the [Supabase CLI installed](https://supabase.com/docs/guides/local-development/cli/getting-started#installing-the-supabase-cli).
