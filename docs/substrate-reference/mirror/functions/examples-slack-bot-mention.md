<!-- source: https://supabase.com/docs/guides/functions/examples/slack-bot-mention · mirrored 2026-08-13 from Supabase docs -->
...
supabase secrets set \
  SLACK_TOKEN=<<redacted-by-mirror: example credential>> \
