<!-- source: https://supabase.com/docs/guides/functions/function-configuration · mirrored 2026-08-13 from Supabase docs -->
...
Note: To see more general `config.toml` options, check out [this guide](https://supabase.com/docs/guides/local-development/managing-config).
...
Caution: Be careful when using this flag, as it will allow anyone to invoke your Edge Function without a valid JWT. The Supabase client libraries automatically handle authorization.
