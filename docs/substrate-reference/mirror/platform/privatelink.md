<!-- source: https://supabase.com/docs/guides/platform/privatelink · mirrored 2026-08-13 from Supabase docs -->

# PrivateLink

Secure private network connectivity to your Supabase database using AWS VPC Lattice.

Note: PrivateLink is available only to Team and Enterprise customers.
...
1. Go to [**Database** > **Settings**](https://supabase.com/dashboard/project/_/database/settings)
