<!-- source: https://supabase.com/docs/guides/platform/migrating-to-supabase/firebase-auth · mirrored 2026-08-13 from Supabase docs -->
...
- [Firestore Storage Migration](https://supabase.com/docs/guides/platform/migrating-to-supabase/firebase-storage)
