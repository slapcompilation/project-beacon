<!-- source: https://supabase.com/docs/guides/platform/aws-marketplace/account-setup · mirrored 2026-08-13 from Supabase docs -->
...
![Supabase product subscribe](https://supabase.com/docs/img/guides/platform/aws-marketplace-onboarding-page-extended--dark.png)
