<!-- source: https://supabase.com/docs/guides/platform/custom-domains · mirrored 2026-08-13 from Supabase docs -->
...
1. [Install](https://supabase.com/docs/guides/local-development) the latest version of the Supabase CLI.
