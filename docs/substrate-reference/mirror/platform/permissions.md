<!-- source: https://supabase.com/docs/guides/platform/permissions · mirrored 2026-08-13 from Supabase docs -->

# Permissions

Permissions requirements for the Supabase Cloud hosting environment
