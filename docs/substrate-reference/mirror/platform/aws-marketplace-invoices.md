<!-- source: https://supabase.com/docs/guides/platform/aws-marketplace/invoices · mirrored 2026-08-13 from Supabase docs -->
...
![Subscription upgrade modal](https://supabase.com/docs/img/guides/platform/aws-marketplace-invoices.png)
