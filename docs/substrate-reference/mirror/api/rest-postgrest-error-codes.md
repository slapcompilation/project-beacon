<!-- source: https://supabase.com/docs/guides/api/rest/postgrest-error-codes · mirrored 2026-08-13 from Supabase docs -->
...
Note: The docs reflect the error codes and information in [PostgREST's official
...
One can filter for API errors in the [log explorer](https://supabase.com/dashboard/project/_/logs/explorer). Below are useful queries for filtering and analyzing API errors:
...
Note: PostgREST error codes are only captured in the logs for projects running V14+. You can check your PostgREST version and upgrade your project in the [General Settings](https://supabase.com/dashboard/project/_/settings/general)
