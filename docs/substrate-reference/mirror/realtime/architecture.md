<!-- source: https://supabase.com/docs/guides/realtime/architecture · mirrored 2026-08-13 from Supabase docs -->

# Realtime Architecture

Architecture of the Supabase Realtime service
...
![Architecture](https://supabase.com/docs/img/guides/platform/realtime/architecture--dark.png)
