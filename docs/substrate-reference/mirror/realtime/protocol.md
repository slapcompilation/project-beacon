<!-- source: https://supabase.com/docs/guides/realtime/protocol · mirrored 2026-08-13 from Supabase docs -->

# Realtime Protocol

Understanding Realtime Protocol
...
[
  ...
  "access_token",
  {
    "access_token": "<redacted-by-mirror: example credential>.KMUFsIDTnFmyG3nMiGM6H9FNFUROf3wh7SmqJp-QV30"
  }
]
```
...
When the subscription was joined with a `select` array (see [phx\_join](#phx_join)), `columns`, `record`, and `old_record` are restricted to the selected columns instead of the full row.
