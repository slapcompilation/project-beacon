<!-- source: https://supabase.com/docs/guides/realtime/authorization · mirrored 2026-08-13 from Supabase docs -->
...
Note: To enforce private channels you need to disable the 'Allow public access' setting in [Realtime Settings](https://supabase.com/dashboard/project/_/realtime/settings)
...
Caution: Increased RLS complexity can impact database performance and connection time, leading to higher connection latency and decreased join rates.
