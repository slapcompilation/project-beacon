<!-- source: https://supabase.com/docs/guides/database/replication/pipelines-monitoring · mirrored 2026-08-13 from Supabase docs -->
...
![Running pipeline status page showing replication metrics and a live table](https://supabase.com/docs/img/database/replication/pipelines-metrics.png)
...
1. Open [**Database > Replication**](https://supabase.com/dashboard/project/_/database/replication) and check the destination's lag column.
...
4. Open [**Logs > Replication**](https://supabase.com/dashboard/project/_/logs/replication-logs) and look for destination errors, retries, rate limits, schema errors, or repeated restarts.
...
- For BigQuery, verify that service account permissions, table requirements, and replica identity settings match the [BigQuery destination guide](https://supabase.com/docs/guides/database/replication/bigquery).
...
3. Navigate to the [**Logs > Replication**](https://supabase.com/dashboard/project/_/logs/replication-logs) section of the Dashboard for detailed error logs
...
1. Navigate to the [**Logs > Replication**](https://supabase.com/dashboard/project/_/logs/replication-logs) section of the Dashboard
2. Select **Replication** from the log source filter
3. You'll see all logs from your pipelines

Note: Logs contain diagnostic information that may be too technical for most users. If you're experiencing issues with replication, reaching out to support with your error details is recommended.
...
4. Navigate to the [**Logs > Replication**](https://supabase.com/dashboard/project/_/logs/replication-logs) section of the Dashboard for full error details
...
3. **Check logs**: Navigate to the [**Logs > Replication**](https://supabase.com/dashboard/project/_/logs/replication-logs) section of the Dashboard for detailed error information
...
For more troubleshooting tips, see the [Pipelines FAQ](https://supabase.com/docs/guides/database/replication/pipelines-faq).
