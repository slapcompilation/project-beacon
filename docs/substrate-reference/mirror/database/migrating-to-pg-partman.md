<!-- source: https://supabase.com/docs/guides/database/migrating-to-pg-partman · mirrored 2026-08-13 from Supabase docs -->
...
- [`pg_partman` documentation](https://supabase.com/docs/guides/database/extensions/pg_partman)
