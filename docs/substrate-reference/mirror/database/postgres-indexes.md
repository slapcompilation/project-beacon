<!-- source: https://supabase.com/docs/guides/database/postgres/indexes · mirrored 2026-08-13 from Supabase docs -->
...
Note: All the queries in this guide can be run using the [SQL Editor](https://supabase.com/dashboard/project/_/sql) in the Supabase Dashboard, or via `psql` if you're [connecting directly to the database](https://supabase.com/docs/guides/database/connecting-to-postgres#direct-connections).
...
Caution: It can take a long time to build indexes on large datasets and the default behaviour of `create index` is to lock the table from writes.
...
![B-Tree index example in Postgres](https://supabase.com/docs/img/database/managing-indexes/creating-indexes.png)
