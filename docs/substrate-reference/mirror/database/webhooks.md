<!-- source: https://supabase.com/docs/guides/database/webhooks · mirrored 2026-08-13 from Supabase docs -->
...
- [pg\_net](https://supabase.com/docs/guides/database/extensions/pg_net): an async networking extension for Postgres
