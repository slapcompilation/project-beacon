<!-- source: https://supabase.com/docs/guides/database/postgres/timeouts · mirrored 2026-08-13 from Supabase docs -->

# Timeouts

Extend database timeouts to execute longer transactions

Note: Dashboard and [Client](https://supabase.com/docs/guides/api/rest/client-libs) queries have a max-configurable timeout of 60 seconds. For longer transactions, use [Supavisor or direct connections](https://supabase.com/docs/guides/database/connecting-to-postgres#quick-summary).
...
Note: If you are changing the timeout for the Supabase Client API calls, you will need to reload PostgREST to reflect the timeout changes by running the following script:
