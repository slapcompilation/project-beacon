<!-- source: https://supabase.com/docs/guides/database/extensions/postgis · mirrored 2026-08-13 from Supabase docs -->
...
{
    new Restaurant { Name = "Supa Burger", Location = "POINT(-73.946823 40.807416)" },
    new Restaurant { Name = "Supa Pizza", Location = "POINT(-73.94581 40.807475)" },
    new Restaurant { Name = "Supa Taco", Location = "POINT(-73.945826 40.80629)" }
};

await supabase.From<Restaurant>().Insert(restaurants);
```
...
```c#
await supabase.Rpc("nearby_restaurants", new Dictionary<string, object>
{
    { "lat", 40.807313 },
    { "long", -73.946713 }
});
