<!-- source: https://supabase.com/docs/guides/database/testing · mirrored 2026-08-13 from Supabase docs -->
...
- [Install the Supabase CLI](https://supabase.com/docs/guides/local-development) on your local machine
