<!-- source: https://supabase.com/docs/guides/database/postgres/event-triggers · mirrored 2026-08-13 from Supabase docs -->
...
See how to [auto enable RLS for new tables](https://supabase.com/docs/guides/database/postgres/row-level-security#auto-enable-rls-for-new-tables).
...
Caution: Event triggers run for each DDL command specified above and can consume resources which may cause performance issues if not used carefully.
