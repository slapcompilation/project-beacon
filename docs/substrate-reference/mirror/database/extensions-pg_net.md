<!-- source: https://supabase.com/docs/guides/database/extensions/pg_net · mirrored 2026-08-13 from Supabase docs -->

# pg_net: Async Networking

pg_net: an async networking extension for Postgres.

Caution: The pg\_net API is in beta. Functions signatures may change.
...
Caution: This is a Postgres [SECURITY DEFINER](https://supabase.com/docs/guides/database/postgres/row-level-security#use-security-definer-functions) function.
...
Note: Supabase supports reconfiguring `pg_net` starting from v0.12.0+. For the latest release, initiate a Postgres upgrade in the [General Settings](https://supabase.com/dashboard/project/_/settings/general).
...
### Call an endpoint every minute with [pg\_cron](https://supabase.com/docs/guides/database/extensions/pg_cron)
