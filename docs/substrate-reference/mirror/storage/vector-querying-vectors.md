<!-- source: https://supabase.com/docs/guides/storage/vector/querying-vectors · mirrored 2026-08-13 from Supabase docs -->
...
Note: Vector buckets and any [Foreign Data Wrappers (FDW)](https://supabase.com/docs/guides/database/extensions/wrappers/overview) they use only support one similarity search algorithm, the `<===>` distance operator.
