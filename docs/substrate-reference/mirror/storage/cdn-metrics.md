<!-- source: https://supabase.com/docs/guides/storage/cdn/metrics · mirrored 2026-08-13 from Supabase docs -->

# Cache Metrics

Learn how Supabase Storage caches objects with a CDN.

Cache hits can be determined via the `metadata.response.headers.cf_cache_status` key in our [Logs Explorer](https://supabase.com/docs/guides/monitoring-and-debugging/logs#logs-explorer). Any value that corresponds to either `HIT`, `STALE`, `REVALIDATED`, or `UPDATING` is categorized as a cache hit.
