<!-- source: https://supabase.com/docs/guides/storage/serving/bandwidth · mirrored 2026-08-13 from Supabase docs -->

# Bandwidth & Storage Egress

Bandwidth & Storage Egress

How to calculate the Bandwidth and Storage Egress
