<!-- source: https://supabase.com/docs/guides/storage/cdn/smart-cdn · mirrored 2026-08-13 from Supabase docs -->
...
Note: Smart CDN caching is automatically enabled for [Pro Plan and above](https://supabase.com/pricing).
