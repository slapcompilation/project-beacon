<!-- source: https://supabase.com/docs/guides/storage/uploads/resumable-uploads · mirrored 2026-08-13 from Supabase docs -->
...
C# supports resumable uploads natively via `UploadOrResume`:

```c#
await supabase.Storage.From("bucket_name")
  .UploadOrResume("local_file_path", "file_path", new FileOptions { Upsert = true });
```
