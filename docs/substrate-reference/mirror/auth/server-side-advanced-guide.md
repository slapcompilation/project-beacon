<!-- source: https://supabase.com/docs/guides/auth/server-side/advanced-guide · mirrored 2026-08-13 from Supabase docs -->
...
Note: In the `@supabase/ssr` package, Supabase clients are initiated to use the PKCE flow by default. They are also automatically configured to handle the saving and retrieval of session information in cookies.
