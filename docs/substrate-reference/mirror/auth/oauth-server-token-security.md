<!-- source: https://supabase.com/docs/guides/auth/oauth-server/token-security · mirrored 2026-08-13 from Supabase docs -->
...
Caution: **Scopes control OIDC data, not database access**
...
Note: Custom Access Token Hooks are triggered for **all** token issuance. Use `client_id` or `authentication_method` (`oauth_provider/authorization_code` for OAuth flows) to differentiate OAuth from regular authentication.
...
Or use the Supabase Dashboard's [RLS policy tester](https://supabase.com/dashboard/project/_/database/policies).
...
- [Row Level Security](https://supabase.com/docs/guides/database/postgres/row-level-security) - Complete RLS guide
