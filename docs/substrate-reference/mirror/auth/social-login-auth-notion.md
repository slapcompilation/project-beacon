<!-- source: https://supabase.com/docs/guides/auth/social-login/auth-notion · mirrored 2026-08-13 from Supabase docs -->
...
When your user signs in, call [`signInWithOAuth()`](https://supabase.com/docs/reference/dart/auth-signinwithoauth) with `notion` as the `provider`:
...
When your user signs in, call [signInWith(Provider)](https://supabase.com/docs/reference/kotlin/auth-signinwithoauth) with `Notion` as the `Provider`:
...
When your user signs in, call [`SignIn()`](https://supabase.com/docs/reference/csharp/sign-in-with-oauth) with `Provider.Notion` as the provider:

```c#
var state = await supabase.Auth.SignIn(Provider.Notion);
