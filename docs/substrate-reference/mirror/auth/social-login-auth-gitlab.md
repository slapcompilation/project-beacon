<!-- source: https://supabase.com/docs/guides/auth/social-login/auth-gitlab · mirrored 2026-08-13 from Supabase docs -->
...
When your user signs in, call [`signInWithOAuth()`](https://supabase.com/docs/reference/dart/auth-signinwithoauth) with `gitlab` as the `provider`:
...
When your user signs in, call [signInWith(Provider)](https://supabase.com/docs/reference/kotlin/auth-signinwithoauth) with `Gitlab` as the `Provider`:
...
When your user signs in, call [`SignIn()`](https://supabase.com/docs/reference/csharp/sign-in-with-oauth) with `Provider.Gitlab` as the provider:
