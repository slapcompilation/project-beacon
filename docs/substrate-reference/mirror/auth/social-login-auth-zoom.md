<!-- source: https://supabase.com/docs/guides/auth/social-login/auth-zoom · mirrored 2026-08-13 from Supabase docs -->
...
When your user signs in, call [`signInWithOAuth()`](https://supabase.com/docs/reference/dart/auth-signinwithoauth) with `zoom` as the `provider`:
...
When your user signs in, call [signInWith(Provider)](https://supabase.com/docs/reference/kotlin/auth-signinwithoauth) with `Zoom` as the `Provider`:
...
When your user signs in, call [`SignIn()`](https://supabase.com/docs/reference/csharp/sign-in-with-oauth) with `Provider.Zoom` as the provider:

```c#
var state = await supabase.Auth.SignIn(Provider.Zoom);
