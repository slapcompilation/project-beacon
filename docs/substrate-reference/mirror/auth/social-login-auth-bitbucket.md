<!-- source: https://supabase.com/docs/guides/auth/social-login/auth-bitbucket · mirrored 2026-08-13 from Supabase docs -->
...
When your user signs in, call [`signInWithOAuth()`](https://supabase.com/docs/reference/dart/auth-signinwithoauth) with `bitbucket` as the `provider`:
...
When your user signs in, call [signInWith(Provider)](https://supabase.com/docs/reference/kotlin/auth-signinwithoauth) with `Bitbucket` as the `Provider`:
...
When your user signs in, call [`SignIn()`](https://supabase.com/docs/reference/csharp/sign-in-with-oauth) with `Provider.Bitbucket` as the provider:
