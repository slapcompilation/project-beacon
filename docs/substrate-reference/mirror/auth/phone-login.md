<!-- source: https://supabase.com/docs/guides/auth/phone-login · mirrored 2026-08-13 from Supabase docs -->
...
Note: At this time, `WhatsApp` is only supported as a channel for the Twilio and Twilio Verify Providers.
