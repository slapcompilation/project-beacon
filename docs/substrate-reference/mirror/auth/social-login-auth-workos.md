<!-- source: https://supabase.com/docs/guides/auth/social-login/auth-workos · mirrored 2026-08-13 from Supabase docs -->
...
Note: You must be signed in to see these values.
...
Note: You can find your `connection_id` in the WorkOS dashboard under the Organizations tab. Select your organization and then click View connection.
