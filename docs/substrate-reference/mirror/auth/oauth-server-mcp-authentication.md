<!-- source: https://supabase.com/docs/guides/auth/oauth-server/mcp-authentication · mirrored 2026-08-13 from Supabase docs -->
...
Caution: Dynamic registration allows any MCP client to register with your project. Consider:
...
Note: **Looking for an easier way to build MCP servers?**
