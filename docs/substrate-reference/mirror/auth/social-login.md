<!-- source: https://supabase.com/docs/guides/auth/social-login · mirrored 2026-08-13 from Supabase docs -->
...
Note: Need to integrate with a provider not listed here? You can add any OAuth2 or OIDC-compatible provider using [Custom OAuth/OIDC Providers](https://supabase.com/docs/guides/auth/custom-oauth-providers).
