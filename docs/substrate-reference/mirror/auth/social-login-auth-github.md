<!-- source: https://supabase.com/docs/guides/auth/social-login/auth-github · mirrored 2026-08-13 from Supabase docs -->
...
When your user signs in, call [`signInWithOAuth()`](https://supabase.com/docs/reference/dart/auth-signinwithoauth) with `github` as the `provider`:
...
When your user signs in, call [`signInWithOAuth`](https://supabase.com/docs/reference/swift/auth-signinwithoauth) with `.github` as the `Provider`:
...
When your user signs in, call [signInWith(Provider)](https://supabase.com/docs/reference/kotlin/auth-signinwithoauth) with [`Github`](https://github.com/supabase-community/supabase-kt/blob/master/Auth/src/commonMain/kotlin/io/github/jan/supabase/auth/providers/Providers.kt#L16-L20) as the `Provider`:
...
When your user signs in, call [`SignIn()`](https://supabase.com/docs/reference/csharp/sign-in-with-oauth) with `Provider.Github` as the provider:
