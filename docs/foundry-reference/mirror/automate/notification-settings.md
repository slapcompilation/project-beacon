<!-- source: https://palantir.com/docs/foundry/automate/notification-settings/ · mirrored 2026-08-18 from Palantir Foundry docs -->
...
![Configure notification settings](./images/automate-notification-user-settings.png)
...
| `Other info`  | Condition edited <br>Subscribed <br>Unsubscribed <br>Muted <br>Unmuted <br>Paused <br>Resumed |
