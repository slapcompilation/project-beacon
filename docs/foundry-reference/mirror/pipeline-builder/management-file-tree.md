<!-- source: https://palantir.com/docs/foundry/pipeline-builder/management-file-tree/ · mirrored 2026-09-04 from Palantir Foundry docs -->
...
![The Pipeline file tree side bar.](./images/file-tree-side-bar.png)
...
![The create new folder button in Pipeline Builder.](./images/file-tree-new-folder.png)
...
![Selecting two nodes and placing them into a folder.](./images/file-tree-move-items.png)

![Selecting nodes from a graph, which highlights the nodes in the side panel.](./images/file-tree-graph-selection.png)
...
![Sub-folder creation using "Create folder" and the provided text box.](./images/file-tree-sub-folder.png)
...
![The delete option on a folder.](./images/file-tree-delete-folder.png)
...
![The show hide functionality on a folder.](./images/file-tree-show-hide.png)

To center the nodes in a folder on your graph, select the target icon.

![The target icon to center your graph around the nodes in the folder.](./images/file-tree-target.png)
