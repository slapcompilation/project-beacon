<!-- source: https://palantir.com/docs/foundry/pipeline-builder/branches-approve-a-change/ · mirrored 2026-09-04 from Palantir Foundry docs -->
...
![Screenshot of the Statistics page](./images/column-stats.png)

Select the **View column stats** icon to view and compare the statistics of the select column.

![Screenshot of the Statistics bottom panel with column metrics](./images/column-stats-view.png)
...
![Screenshot showing the "mark changes as reviewed" interface.](./images/mark-as-reviewed.png)
...
![Screenshot showing the checkbox to mark a change as reviewed.](./images/mark-as-reviewed-check.png)
...
![Screenshot showing comments on the overview page.](./images/comments-on-main-page.png)
...
![Screenshot showing comments in the changes tab.](./images/comments-start.png)
...
![Screenshot showing comments in a node.](./images/comments-in-node.png)
...
![Screenshot showing comments in a node.](./images/comments-edit.png)
...
![Screenshot showing comments in a node.](./images/comments-resolve-in-node.png)
...
![Screenshot of resolving all comments.](./images/comments-resolve-all.png)
...
![Screenshot of branch changing an output](./images/branches-fail-to-compute@2x.png)
...
![Screenshot of branch join error](./images/branches-join-error@2x.png)

Double-click on the step in the graph that has the error and resolve the conditions that are problematic.

![Screenshot of branch error resolution](./images/branches-resolve-error@2x.png)
...
![Resolve merge conflict proposal pane](./images/branch-proposal-conflict.png)
