<!-- source: https://palantir.com/docs/foundry/pipeline-builder/transforms-join-data/ · mirrored 2026-08-18 from Palantir Foundry docs -->
...
![Screenshot of transforms join data](./images/transforms-join-data@2x.png)
...
![Screenshot of transforms join two tables](./images/transforms-join-two-tables@2x.png)
...
![Screenshot of transform configuration](./images/transforms-join-configure@2x.png)
...
![Screenshot of transform advanced configuration](./images/transforms-show-advanced@2x.png)
...
![Screenshot of transform join person data completion](./images/transforms-join-person-data@2x.png)
