<!-- source: https://palantir.com/docs/foundry/pipeline-builder/schedules-create-schedule/ · mirrored 2026-08-18 from Palantir Foundry docs -->
...
![Screenshot of creating a schedule selection dropdown](./images/schedules-create-schedule@2x.png)

In the dataset preview pane, click the **Schedules** tab and select **Add build schedule**.

![Screenshot of creating a schedule selection dropdown](./images/schedules-create2@2x.png)
...
![Screenshot of creating a schedule when a parent resource updates](./images/schedules-new-schedule@2x.png)
...
![Screenshot of choosing a specific time for the schedule](./images/schedules-specific-time@2x.png)
