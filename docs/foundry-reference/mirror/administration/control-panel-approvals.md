<!-- source: https://palantir.com/docs/foundry/administration/control-panel-approvals/ · mirrored 2026-08-06 from Palantir Foundry docs -->
...
![The Control Panel Approvals inbox interface shows current approval requests.](./images/control-panel-approvals-inbox.png)
