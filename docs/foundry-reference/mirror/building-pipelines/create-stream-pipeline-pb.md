<!-- source: https://palantir.com/docs/foundry/building-pipelines/create-stream-pipeline-pb/ · mirrored 2026-09-04 from Palantir Foundry docs -->
...
![Screenshot of stream create dropdown](./images/stream-create-dropdown.png)
...
![Screenshot of stream definition page](./images/stream-define.png)
...
![Screenshot of stream connection page](./images/stream-connect.png)
...
![Screenshot of stream connection auth page](./images/stream-push-auth.png)
...
![Screenshot of stream push with curl page](./images/stream-push-curl.png)
...
![Screenshot of stream view records tab](./images/stream-start-pipelining.png)

2. In the **Create new pipeline** modal, select the **Streaming pipeline** type, and click **Create Pipeline**.

![Screenshot of create builder stream pipeline](./images/create-new-stream-pipeline.png)
...
![Screenshot of builder graph with input stream](./images/stream-input-pb.png)
...
![Screenshot of builder stream transform dropdown](./images/stream-transform-dropdown.png)

4. Select the **Uppercase** transform, choose the `sensor_id` column, and click **Apply**.

![Screenshot of builder stream uppercase transform](./images/stream-uppercase-transform-pb.png)

5. Then, search for the **Trim whitespace** transform and select it. Choose the `sensor_id` column again, and click **Apply**.

![Screenshot of builder trim whitespace transform](./images/stream-trim-whitespace-transform-pb.png)
...
![Screenshot of builder filter transform](./images/stream-filter-transform-pb.png)

7. Click **Apply all changes** to the top right of your screen. Then, select **Back to graph** to return to your pipeline.

![Screenshot of builder graph with transform](./images/stream-transform-graph.png)

8. Select the **Transform path** node we just created, then click **New dataset**.

![Screenshot of builder graph creating new output](./images/stream-transform-new-dataset-pb.png)
...
![Screenshot of builder graph deploy dropdown](./images/stream-builder-graph.png)
...
![Screenshot of builder graph with deployed output](./images/stream-deployed-builder-graph.png)
...
![Screenshot of output stream](./images/stream-view-output.png)
