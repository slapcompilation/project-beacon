<!-- source: https://palantir.com/docs/foundry/functions/custom-aliases/ · mirrored 2026-08-18 from Palantir Foundry docs -->
...
Custom aliases store string values for configuration. To reference language models by name in your functions, see [Model aliases](/docs/foundry/functions/model-aliases/).
:::
...
![The Resource imports side panel showing the Platform SDK tab with the custom aliases option.](./images/custom-aliases-sidebar.png)
...
![The new alias dialog with a key set to myAlias and a value set to someValue.](./images/custom-aliases-create.png)
...
![The custom aliases list showing a created alias with an option to edit the value.](./images/custom-aliases-edit.png)
...
![A Marketplace product showing the custom alias as a configurable parameter input alongside the function output.](./images/custom-aliases-marketplace-product.png)
...
![The Details panel for a custom alias parameter showing a description field.](./images/custom-aliases-set-description.png)
...
![The Presets tab showing manual override configuration with preset values for the alias.](./images/custom-aliases-add-presets.png)
...
![The installation view showing the custom alias parameter with its description and preset value options.](./images/custom-aliases-install.png)
