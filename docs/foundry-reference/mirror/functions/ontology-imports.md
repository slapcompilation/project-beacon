<!-- source: https://palantir.com/docs/foundry/functions/ontology-imports/ · mirrored 2026-09-04 from Palantir Foundry docs -->
...
![ontology-import-side-panel](./images/ontology-import-side-panel.png)
...
![The option to import interfaces under the "Add" dropdown.](./images/interface-import-example.png)
...
![ontology-api](./images/ontology-api.png)
