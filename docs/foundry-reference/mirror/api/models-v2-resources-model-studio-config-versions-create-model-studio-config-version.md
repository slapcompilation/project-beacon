<!-- source: https://palantir.com/docs/foundry/api/models-v2-resources/model-studio-config-versions/create-model-studio-config-version/ · mirrored 2026-08-19 from Palantir Foundry docs -->
