<!-- source: https://palantir.com/docs/foundry/api/v2/connectivity-v2-resources/connections/get-configuration/ · mirrored 2026-08-19 from Palantir Foundry docs -->
...
- `GetConfigurationPermissionDenied` (PERMISSION_DENIED) — "Could not getConfiguration the Connection."
