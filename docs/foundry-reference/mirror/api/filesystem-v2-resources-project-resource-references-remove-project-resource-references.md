<!-- source: https://palantir.com/docs/foundry/api/filesystem-v2-resources/project-resource-references/remove-project-resource-references/ · mirrored 2026-08-19 from Palantir Foundry docs -->
