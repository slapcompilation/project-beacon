<!-- source: https://palantir.com/docs/foundry/api/v1/ontology-resources/attachments/get-attachment/ · mirrored 2026-08-15 from Palantir Foundry docs -->

# Get Attachment

`GET /api/v1/attachments/{attachmentRid}`
