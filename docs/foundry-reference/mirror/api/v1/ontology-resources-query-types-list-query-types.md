<!-- source: https://palantir.com/docs/foundry/api/v1/ontology-resources/query-types/list-query-types/ · mirrored 2026-08-15 from Palantir Foundry docs -->

# List Query Types

`GET /api/v1/ontologies/{ontologyRid}/queryTypes`
...
- `ontologyRid` · string · required
  "The unique Resource Identifier (RID) of the Ontology that contains the query types. To look up your Ontology RID, please use the **List ontologies** endpoint or check the **Ontology Manager**."
...
- `ListQueryTypesResponse` · object · required
  "Success response."
