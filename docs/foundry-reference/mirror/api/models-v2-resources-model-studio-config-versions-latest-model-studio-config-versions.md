<!-- source: https://palantir.com/docs/foundry/api/models-v2-resources/model-studio-config-versions/latest-model-studio-config-versions/ · mirrored 2026-08-19 from Palantir Foundry docs -->
