<!-- source: https://palantir.com/docs/foundry/api/v2/models-v2-resources/model-studio-config-versions/create-model-studio-config-version/ · mirrored 2026-08-19 from Palantir Foundry docs -->
...
- `CreateModelStudioConfigVersionRequest` · object · required
...
- `CreateConfigValidationError` (INVALID_ARGUMENT) — "The provided configuration is invalid."
- `CreateModelStudioConfigVersionPermissionDenied` (PERMISSION_DENIED) — "Could not create the ModelStudioConfigVersion."
