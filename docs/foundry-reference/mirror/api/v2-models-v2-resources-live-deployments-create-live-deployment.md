<!-- source: https://palantir.com/docs/foundry/api/v2/models-v2-resources/live-deployments/create-live-deployment/ · mirrored 2026-08-19 from Palantir Foundry docs -->
...
- `CreateLiveDeploymentRequest` · object · required
  - `deploymentType` · union · required
...
- `CreateLiveDeploymentPermissionDenied` (PERMISSION_DENIED) — "Could not create the LiveDeployment."
