<!-- source: https://palantir.com/docs/foundry/api/v2/data-health-v2-resources/check-reports/get-latest-check-reports/ · mirrored 2026-08-19 from Palantir Foundry docs -->

# Get Latest Check Reports

`GET /api/v2/dataHealth/checks/{checkRid}/checkReports/getLatest`
...
- `limit` · integer
  "The maximum number of check reports to return. Defaults to 10. Maximum allowed value is 100."
- `preview` · boolean
  "Enables the use of preview functionality."

## Response

- `GetLatestCheckReportsResponse` · object · required
...
- `GetLatestCheckReportsPermissionDenied` (PERMISSION_DENIED) — "Could not getLatest the CheckReport."
