<!-- source: https://palantir.com/docs/foundry/api/v1/datasets-resources/transactions/commit-transaction/ · mirrored 2026-08-19 from Palantir Foundry docs -->

# Commit Transaction

`POST /api/v1/datasets/{datasetRid}/transactions/{transactionRid}/commit`
