<!-- source: https://palantir.com/docs/foundry/api/v2/sql-queries-v2-resources/sql-queries/get-status-sql-query/ · mirrored 2026-08-19 from Palantir Foundry docs -->
