<!-- source: https://palantir.com/docs/foundry/api/v2/datasets-v2-resources/datasets/get-dataset-schema/ · mirrored 2026-08-19 from Palantir Foundry docs -->
...
- `GetDatasetSchemaPermissionDenied` (PERMISSION_DENIED) — "Could not getSchema the Dataset."
