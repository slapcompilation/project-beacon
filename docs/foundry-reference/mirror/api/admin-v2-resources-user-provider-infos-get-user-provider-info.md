<!-- source: https://palantir.com/docs/foundry/api/admin-v2-resources/user-provider-infos/get-user-provider-info/ · mirrored 2026-08-19 from Palantir Foundry docs -->
