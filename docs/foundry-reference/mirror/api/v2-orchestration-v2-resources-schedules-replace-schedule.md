<!-- source: https://palantir.com/docs/foundry/api/v2/orchestration-v2-resources/schedules/replace-schedule/ · mirrored 2026-08-19 from Palantir Foundry docs -->

# Replace Schedule

`PUT /api/v2/orchestration/schedules/{scheduleRid}`
...
- `ReplaceScheduleRequest` · object · required
  - `displayName` · string
  - `description` · string
...
- `ReplaceSchedulePermissionDenied` (PERMISSION_DENIED) — "Could not replace the Schedule."
