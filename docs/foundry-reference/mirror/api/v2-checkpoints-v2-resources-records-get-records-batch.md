<!-- source: https://palantir.com/docs/foundry/api/v2/checkpoints-v2-resources/records/get-records-batch/ · mirrored 2026-08-19 from Palantir Foundry docs -->
...
- `body` · list · required
  - `GetRecordsBatchRequestElement` · object · required
    - `recordRid` · string · required
      "Identifier of a checkpoint record."

## Response

- `GetRecordsBatchResponse` · object · required
  - `data` · map
    - `RecordRid` · string · required
      "Identifier of a checkpoint record."
