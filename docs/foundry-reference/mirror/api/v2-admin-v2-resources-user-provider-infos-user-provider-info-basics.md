<!-- source: https://palantir.com/docs/foundry/api/v2/admin-v2-resources/user-provider-infos/user-provider-info-basics/ · mirrored 2026-08-19 from Palantir Foundry docs -->
