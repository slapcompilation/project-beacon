<!-- source: https://palantir.com/docs/foundry/api/v2/data-health-v2-resources/checks/replace-check/ · mirrored 2026-08-19 from Palantir Foundry docs -->
...
- `ReplaceCheckRequest` · object · required
...
- `ModifyingCheckTypeNotSupported` (INVALID_ARGUMENT) — "Changing the type of a check after it has been created is not supported."
...
- `ReplaceCheckPermissionDenied` (PERMISSION_DENIED) — "Could not replace the Check."
