<!-- source: https://palantir.com/docs/foundry/api/v2/functions-v2-resources/queries/get-by-rid-queries-batch/ · mirrored 2026-08-19 from Palantir Foundry docs -->
...
- `body` · list · required
  - `GetByRidQueriesBatchRequestElement` · object · required
...
- `GetByRidQueriesBatchResponse` · object · required
  - `data` · list
