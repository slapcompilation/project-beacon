<!-- source: https://palantir.com/docs/foundry/api/v2/connectivity-v2-resources/table-imports/create-table-import/ · mirrored 2026-08-19 from Palantir Foundry docs -->
...
- `CreateTableImportRequest` · object · required
...
- `CreateTableImportPermissionDenied` (PERMISSION_DENIED) — "Could not create the TableImport."
