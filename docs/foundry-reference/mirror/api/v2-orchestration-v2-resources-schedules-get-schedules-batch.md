<!-- source: https://palantir.com/docs/foundry/api/v2/orchestration-v2-resources/schedules/get-schedules-batch/ · mirrored 2026-08-19 from Palantir Foundry docs -->
...
- `body` · list · required
  - `GetSchedulesBatchRequestElement` · object · required
    - `scheduleRid` · string · required
      "The RID of a Schedule."

## Response

- `GetSchedulesBatchResponse` · object · required
  - `data` · map
    - `ScheduleRid` · string · required
      "The RID of a Schedule."
