<!-- source: https://palantir.com/docs/foundry/api/v2/ontologies-v2-resources/ontology-interfaces/get-interface-type/ · mirrored 2026-08-19 from Palantir Foundry docs -->
...
- `branch` · string
  "The Foundry branch to load the interface type definition from. If not specified, the default branch will be used. Branches are an experimental feature and not all workflows are supported."
