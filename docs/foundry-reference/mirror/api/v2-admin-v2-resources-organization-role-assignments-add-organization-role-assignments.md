<!-- source: https://palantir.com/docs/foundry/api/v2/admin-v2-resources/organization-role-assignments/add-organization-role-assignments/ · mirrored 2026-08-19 from Palantir Foundry docs -->
...
- `AddOrganizationRoleAssignmentsRequest` · object · required
...
- `AddOrganizationRoleAssignmentsPermissionDenied` (PERMISSION_DENIED) — "Could not add the OrganizationRoleAssignment."
