<!-- source: https://palantir.com/docs/foundry/api/v2/orchestration-v2-resources/schedule-versions/get-schedule-of-schedule-version/ · mirrored 2026-08-14 from Palantir Foundry docs -->

# Get Schedule Of Schedule Version

`GET /api/v2/orchestration/scheduleVersions/{scheduleVersionRid}/schedule`
