<!-- source: https://palantir.com/docs/foundry/api/v2/streams-v2-resources/streams/publish-binary-record-to-stream/ · mirrored 2026-08-15 from Palantir Foundry docs -->
