<!-- source: https://palantir.com/docs/foundry/api/v2/filesystem-v2-resources/resources/get-by-path-resources-batch/ · mirrored 2026-08-15 from Palantir Foundry docs -->
...
- `body` · list · required
  - `GetByPathResourcesBatchRequestElement` · object · required
    - `path` · string · required
      "The path to the resource. The leading slash is optional."

## Response

- `GetByPathResourcesBatchResponse` · object · required
  - `data` · list
