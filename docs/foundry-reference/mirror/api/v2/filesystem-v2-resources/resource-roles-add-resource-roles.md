<!-- source: https://palantir.com/docs/foundry/api/v2/filesystem-v2-resources/resource-roles/add-resource-roles/ · mirrored 2026-08-15 from Palantir Foundry docs -->

# Add Resource Roles

`POST /api/v2/filesystem/resources/{resourceRid}/roles/add`
...
- `AddResourceRolesRequest` · object · required
  - `roles` · list
...
- `AddResourceRolesPermissionDenied` (PERMISSION_DENIED) — "Could not add the ResourceRole."
