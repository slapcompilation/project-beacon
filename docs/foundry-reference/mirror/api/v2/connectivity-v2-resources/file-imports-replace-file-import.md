<!-- source: https://palantir.com/docs/foundry/api/v2/connectivity-v2-resources/file-imports/replace-file-import/ · mirrored 2026-08-15 from Palantir Foundry docs -->

# Replace File Import

`PUT /api/v2/connectivity/connections/{connectionRid}/fileImports/{fileImportRid}`
...
- `ReplaceFileImportRequest` · object · required
...
- `ReplaceFileImportPermissionDenied` (PERMISSION_DENIED) — "Could not replace the FileImport."
