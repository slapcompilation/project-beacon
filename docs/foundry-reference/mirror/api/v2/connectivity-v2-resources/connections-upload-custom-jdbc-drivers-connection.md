<!-- source: https://palantir.com/docs/foundry/api/v2/connectivity-v2-resources/connections/upload-custom-jdbc-drivers-connection/ · mirrored 2026-08-15 from Palantir Foundry docs -->
...
- `UploadCustomJdbcDriversConnectionPermissionDenied` (PERMISSION_DENIED) — "Could not uploadCustomJdbcDrivers the Connection."
