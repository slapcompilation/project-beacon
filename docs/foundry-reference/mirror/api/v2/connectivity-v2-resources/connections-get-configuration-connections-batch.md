<!-- source: https://palantir.com/docs/foundry/api/v2/connectivity-v2-resources/connections/get-configuration-connections-batch/ · mirrored 2026-08-15 from Palantir Foundry docs -->
...
Scopes: `api:connectivity-connection-read`

## Request

- `body` · list · required
  - `GetConfigurationConnectionsBatchRequestElement` · object · required
    - `connectionRid` · string · required
      "The Resource Identifier (RID) of a Connection (also known as a source)."

## Response

- `GetConfigurationConnectionsBatchResponse` · object · required
  - `data` · map
    - `ConnectionRid` · string · required
      "The Resource Identifier (RID) of a Connection (also known as a source)."
    - `ConnectionConfiguration` · union · required
      - `s3` · object
