<!-- source: https://palantir.com/docs/foundry/api/v2/datasets-v2-resources/views/remove-backing-datasets/ · mirrored 2026-08-15 from Palantir Foundry docs -->
...
- `RemoveBackingDatasetsRequest` · object · required
  - `branch` · string
...
- `RemoveBackingDatasetsPermissionDenied` (PERMISSION_DENIED) — "Could not removeBackingDatasets the View."
