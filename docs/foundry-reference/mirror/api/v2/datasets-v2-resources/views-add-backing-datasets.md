<!-- source: https://palantir.com/docs/foundry/api/v2/datasets-v2-resources/views/add-backing-datasets/ · mirrored 2026-08-15 from Palantir Foundry docs -->

# Add Backing Datasets

`POST /api/v2/datasets/views/{viewDatasetRid}/addBackingDatasets`
...
- `AddBackingDatasetsRequest` · object · required
  - `branch` · string
...
- `AddBackingDatasetsPermissionDenied` (PERMISSION_DENIED) — "Could not addBackingDatasets the View."
