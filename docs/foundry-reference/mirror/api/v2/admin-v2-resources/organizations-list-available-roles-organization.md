<!-- source: https://palantir.com/docs/foundry/api/v2/admin-v2-resources/organizations/list-available-roles-organization/ · mirrored 2026-08-15 from Palantir Foundry docs -->
