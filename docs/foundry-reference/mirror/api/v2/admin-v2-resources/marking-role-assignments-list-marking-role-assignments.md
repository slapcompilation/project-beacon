<!-- source: https://palantir.com/docs/foundry/api/v2/admin-v2-resources/marking-role-assignments/list-marking-role-assignments/ · mirrored 2026-08-15 from Palantir Foundry docs -->
