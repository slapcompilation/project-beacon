<!-- source: https://palantir.com/docs/foundry/api/v2/admin-v2-resources/users/get-users-batch/ · mirrored 2026-08-15 from Palantir Foundry docs -->
...
- `body` · list · required
  - `GetUsersBatchRequestElement` · object · required
...
- `GetUsersBatchResponse` · object · required
  - `data` · map
    - `UserId` · string · required
      "A Foundry User ID."
