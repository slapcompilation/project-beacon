<!-- source: https://palantir.com/docs/foundry/api/v2/admin-v2-resources/groups/search-groups/ · mirrored 2026-08-15 from Palantir Foundry docs -->
...
- `SearchGroupsRequest` · object · required
...
- `SearchGroupsResponse` · object · required
  - `data` · list
...
- `SearchGroupsPermissionDenied` (PERMISSION_DENIED) — "Could not search the Group."
