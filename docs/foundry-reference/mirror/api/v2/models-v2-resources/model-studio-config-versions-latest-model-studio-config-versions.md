<!-- source: https://palantir.com/docs/foundry/api/v2/models-v2-resources/model-studio-config-versions/latest-model-studio-config-versions/ · mirrored 2026-08-15 from Palantir Foundry docs -->
