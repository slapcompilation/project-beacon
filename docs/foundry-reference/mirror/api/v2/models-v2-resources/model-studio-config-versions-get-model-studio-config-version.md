<!-- source: https://palantir.com/docs/foundry/api/v2/models-v2-resources/model-studio-config-versions/get-model-studio-config-version/ · mirrored 2026-08-15 from Palantir Foundry docs -->
...
- `modelStudioConfigVersionVersion` · integer · required
...
- `ModelStudioConfigVersionNotFound` (NOT_FOUND) — "The given ModelStudioConfigVersion could not be found."
