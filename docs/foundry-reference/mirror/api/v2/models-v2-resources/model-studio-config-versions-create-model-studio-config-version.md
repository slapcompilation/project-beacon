<!-- source: https://palantir.com/docs/foundry/api/v2/models-v2-resources/model-studio-config-versions/create-model-studio-config-version/ · mirrored 2026-08-15 from Palantir Foundry docs -->
