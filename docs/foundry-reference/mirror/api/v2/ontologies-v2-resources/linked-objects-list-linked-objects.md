<!-- source: https://palantir.com/docs/foundry/api/v2/ontologies-v2-resources/linked-objects/list-linked-objects/ · mirrored 2026-08-14 from Palantir Foundry docs -->
...
- `branch` · string
  "The Foundry branch to list linked objects from. If not specified, the default branch will be used. Branches are an experimental feature and not all workflows are supported."

## Response

- `ListLinkedObjectsResponseV2` · object · required
  "Success response."
  - `data` · list
