<!-- source: https://palantir.com/docs/foundry/api/v2/data-health-v2-resources/checks/create-check/ · mirrored 2026-08-15 from Palantir Foundry docs -->
...
- `CreateCheckRequest` · object · required
...
- `CheckAlreadyExists` (CONFLICT) — "A check of the given type for the given subject(s) already exists. The conflicting check will be returned
if the provided token has permission to view it."
- `InvalidTimeCheckConfig` (INVALID_ARGUMENT) — "The TimeCheckConfig is invalid. It must contain at least one of timeBounds or medianDeviation."
- `InvalidPercentageCheckConfig` (INVALID_ARGUMENT) — "The PercentageCheckConfig is invalid. It must contain at least one of percentageBounds or medianDeviation."
- `InvalidNumericColumnCheckConfig` (INVALID_ARGUMENT) — "The NumericColumnCheckConfig is invalid. It must contain at least one of numericBounds or trend."
- `InvalidTrendConfig` (INVALID_ARGUMENT) — "The TrendConfig is invalid. It must contain at least one of trendType or differenceBounds."
- `InvalidTransactionTimeCheckConfig` (INVALID_ARGUMENT) — "The TransactionTimeCheckConfig is invalid. It must contain at least one of timeBounds or medianDeviation."
- `CheckTypeNotSupported` (INVALID_ARGUMENT) — "The type of the requested check is not yet supported in the Platform API."
- `CreateCheckPermissionDenied` (PERMISSION_DENIED) — "Could not create the Check."
