<!-- source: https://palantir.com/docs/foundry/api/v2/filesystem-v2-resources/project-resource-references/add-project-resource-references/ · mirrored 2026-08-19 from Palantir Foundry docs -->
