<!-- source: https://palantir.com/docs/foundry/api/v2/data-health-v2-resources/check-reports/get-check-report/ · mirrored 2026-08-19 from Palantir Foundry docs -->

# Get Check Report

`GET /api/v2/dataHealth/checks/{checkRid}/checkReports/{checkReportRid}`
...
- `checkReportRid` · string · required
...
- `CheckReportNotFound` (NOT_FOUND) — "The given CheckReport could not be found."
