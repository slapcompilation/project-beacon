<!-- source: https://palantir.com/docs/foundry/api/v2/data-health-v2-resources/checks/get-check/ · mirrored 2026-08-19 from Palantir Foundry docs -->

# Get Check

`GET /api/v2/dataHealth/checks/{checkRid}`
