<!-- source: https://palantir.com/docs/foundry/api/v2/aip-agents-v2-resources/sessions/get-rag-context-for-session/ · mirrored 2026-08-19 from Palantir Foundry docs -->
...
- `GetRagContextForSessionRequest` · object · required
  ...
  - `parameterInputs` · map
    "Any values for [application variables](/docs/foundry/chatbot-studio/application-state/) to use for the context retrieval."
...
- `AgentSessionRagContextResponse` · object · required
...
- `GetRagContextForSessionPermissionDenied` (PERMISSION_DENIED) — "Could not ragContext the Session."
