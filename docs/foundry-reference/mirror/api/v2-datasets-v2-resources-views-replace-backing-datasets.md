<!-- source: https://palantir.com/docs/foundry/api/v2/datasets-v2-resources/views/replace-backing-datasets/ · mirrored 2026-08-19 from Palantir Foundry docs -->

# Replace Backing Datasets

`PUT /api/v2/datasets/views/{viewDatasetRid}/replaceBackingDatasets`
...
- `ReplaceBackingDatasetsRequest` · object · required
  - `branch` · string
...
- `ReplaceBackingDatasetsPermissionDenied` (PERMISSION_DENIED) — "Could not replaceBackingDatasets the View."
