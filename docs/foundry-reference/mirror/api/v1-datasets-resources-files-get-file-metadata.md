<!-- source: https://palantir.com/docs/foundry/api/v1/datasets-resources/files/get-file-metadata/ · mirrored 2026-08-19 from Palantir Foundry docs -->

# Get File Metadata

`GET /api/v1/datasets/{datasetRid}/files/{filePath}`
