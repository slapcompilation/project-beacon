<!-- source: https://palantir.com/docs/foundry/api/v2/admin-v2-resources/marking-role-assignments/add-marking-role-assignments/ · mirrored 2026-08-19 from Palantir Foundry docs -->
