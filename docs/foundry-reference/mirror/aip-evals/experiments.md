<!-- source: https://palantir.com/docs/foundry/aip-evals/experiments/ · mirrored 2026-08-18 from Palantir Foundry docs -->
...
![A diagram explaining the experiments process.](./images/aip-evals-experiments-illustration.png)
...
![Adding a model as an optional input and extraPromptContext as a required input to a Logic function.](./images/aip-evals-logic-inputs-setup.png)
...
![The model selector in a UseLLM block, displaying the model variable under the "Registered" tab.](./images/aip-evals-model-block-setup.png)

### Enable experiments

After parameterizing your Logic function, enable experiments by turning on the toggle in the **Run configuration** dialog.

![Enabling the "Experiments" toggle in the "Run configuration" dialog.](./images/aip-evals-enable-experiments.png)
...
![The "Run configuration" dialog with inputs for the experiment name and parameters. ](./images/aip-evals-define-experiment.png)
...
![A preview of the total evaluation runs.](./images/aip-evals-experiment-preview.png)

## Run the experiment

To run the experiment, close the dialog and select the **Run experiment** option.

<img src="./images/aip-evals-run-experiment.png" alt='The "Run experiment" option shown below evaluation test cases.' width=500>
...
<img src="./images/aip-evals-experiment-complete-callout.png" alt='The "Experiment complete" notification, with a link to see experiment results.' width=500>
...
![The "Runs" table in Evals, filtered down to the latest experiment.](./images/aip-evals-runs-table-experiment.png)
...
![Grouping by model to view aggregate metrics.](./images/aip-evals-runs-table-group-by.png)
...
![The "View test cases" option.](./images/aip-evals-view-test-cases.png)
...
![Experiment metadata seen when hovering over the model prompt experiment tag.](./images/aip-evals-test-cases-table-metadata.png)
...
![Hide and show columns in test cases table.](./images/aip-evals-test-cases-table-columns.png)
...
![The "Open" option that is displayed in a row on hover.](./images/aip-evals-test-cases-table-hover.png)
...
![The test case debugger.](./images/aip-evals-debugger-drawer.png)
