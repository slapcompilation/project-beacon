<!-- source: https://palantir.com/docs/foundry/workshop/scenarios-load/ · mirrored 2026-08-18 from Palantir Foundry docs -->
...
![create-scenario-array-from-object](./images/create-scenario-array-from-object.png)
...
![select-scenario-object-set](./images/select-scenario-object-set.png)
...
![preview-scenario-array](./images/preview-scenario-array.png)
...
![select-scenario-array](./images/select-scenario-array.png)
