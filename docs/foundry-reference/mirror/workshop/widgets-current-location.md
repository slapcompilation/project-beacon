<!-- source: https://palantir.com/docs/foundry/workshop/widgets-current-location/ · mirrored 2026-08-18 from Palantir Foundry docs -->
...
![current location manager](./images/current-location-manager.png)

If the user denies access to their current location, a warning is shown and no current location variable value is set:

![current location permission denied](./images/current-location-permission-denied.png)
