<!-- source: https://palantir.com/docs/foundry/quiver/card-cross-filter/ · mirrored 2026-08-22 from Palantir Foundry docs -->
...
![An example of cross filtering.](./images/howto-chart-selection-cross-filtering.gif)
...
1. Select the input object set that you want the charts to filter.
    ...
    <img alt="Select root object set" src="./images/howto-chart-selection-cross-filtering-select-root-object-set.png" width="400px">
...
2. Then, create categorical charts that take the cross filter card as input. The following charts are supported in the cross filter card:
   ...
   * Categorical scatter plots
    ...
    <img alt="Select root object set" src="./images/howto-chart-selection-cross-filtering-select-cross-filtered-object-set.png" width="400px">
...
3. Lastly, open the editor panel of the cross filter card and add the charts above to the **Subscribed plots** category. Charts that are subscribed to the cross filter will act as filters on the object set and also filter each other.
    ...
    <img alt="Adding charts to cross filter object set card" src="./images/howto-chart-selection-cross-filtering-adding-charts.png" width="400px">
