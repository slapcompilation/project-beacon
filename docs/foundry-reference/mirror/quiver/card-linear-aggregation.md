<!-- source: https://palantir.com/docs/foundry/quiver/card-linear-aggregation/ · mirrored 2026-08-18 from Palantir Foundry docs -->
...
![Linear aggregation example](./images/resource-linear-aggregation-example.png)
