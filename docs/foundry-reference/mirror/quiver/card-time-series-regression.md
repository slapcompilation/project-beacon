<!-- source: https://palantir.com/docs/foundry/quiver/card-time-series-regression/ · mirrored 2026-08-18 from Palantir Foundry docs -->
...
![Time series regression example](./images/card-time-series-regression.png)
