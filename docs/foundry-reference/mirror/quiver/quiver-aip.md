<!-- source: https://palantir.com/docs/foundry/quiver/quiver-aip/ · mirrored 2026-08-18 from Palantir Foundry docs -->
...
![Red rectangle highlighting the AIP Generate input below the next actions bar.](./images/aip-generate-input-section.png)
...
![Showing the options generated by AIP based on a user prompt.](./images/aip-generate-initial-options.png)
...
![Showing a follow up action generated by AIP.](./images/aip-generate-with-follow-up.png)
...
![Showing the Chain Of Thought generated by AIP](./images/aip-generate-chain-of-thought.png)
...
![Visualize next action category showing which actions support AIP Generate.](./images/aip-icon-indicator-2.png)
...
![Red rectangle highlighting the AIP Generate button in the top left menu bar and the prompt suggestions.](./images/aip-generate-dialog.png)
...
<img src="./images/aip-generate-cursor-hover-explanation-2.png" alt="LLM configuration explanation when hovering over a card." width="700" >
...
![Red rectangle highlighting the AIP Configure modify button in the input section.](./images/aip-configure-modify-button.png)
...
![Showing options generated by AIP Configure.](./images/aip-configure-with-options-and-changes.png)
...
![Showing AIP Configure on a card which does not support AIP generate.](./images/aip-configure-without-generate.png)
...
![Red rectangle showing a selected series and AIP configure](./images/aip-configure-shows-on-selection-of-series.png)
