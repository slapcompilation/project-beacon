<!-- source: https://palantir.com/docs/foundry/quiver/card-ontology-sql/ · mirrored 2026-09-04 from Palantir Foundry docs -->
...
The Ontology SQL card is the recommended approach for writing SQL against object sets. For cases when Ontology SQL is not suitable, such as for certain unsupported operations, consider using the [Dataset SQL](/docs/foundry/quiver/card-dataset-sql/) card as a fallback.
