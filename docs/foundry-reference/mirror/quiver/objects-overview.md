<!-- source: https://palantir.com/docs/foundry/quiver/objects-overview/ · mirrored 2026-08-22 from Palantir Foundry docs -->
...
![Add object data to your analysis.](./images/getting-started-adding-objects.gif)
...
![Add a single object to your analysis.](./images/howto-object-single-add.gif)
...
![Create a new analysis from an object set in Object Explorer.](./images/howto-object-set-from-oe.gif)
...
![Import a saved object set.](./images/howto-object-set-import.png)
