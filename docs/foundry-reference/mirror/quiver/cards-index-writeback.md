<!-- source: https://palantir.com/docs/foundry/quiver/cards-index-writeback/ · mirrored 2026-08-22 from Palantir Foundry docs -->
...
<img alt="Action button Editor showing the select action dropdown with existing actions to select from" src="./images/howto-action-button-select-action.png" width="350px">
...
<img alt="Time series chart editor showing the select ontology action button dropdown with existing buttons to select from" src="./images/howto-action-button-add-to-time-series-chart.png" width="350px">
...
<img alt="Action button showing a time series chat override" src="./images/action-time-series-override.png" width="350px">
...
<img alt="Action button Editor window showing the button display configuration options" src="./images/howto-action-button-display-config.png" width="350px">
