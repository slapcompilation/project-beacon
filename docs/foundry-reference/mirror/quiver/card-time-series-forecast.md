<!-- source: https://palantir.com/docs/foundry/quiver/card-time-series-forecast/ · mirrored 2026-08-18 from Palantir Foundry docs -->
...
![Forecasts overview](./images/howto-forecast-time-series-overview.png)
...
![Input plot](./images/howto-forecast-time-series-input-plot.png)

2. Select **Time Series Forecast** from the Time Series menu.

  <img src="./images/howto-forecast-time-series-menu.png" alt="Time series forecast menu" width=300/>

3. In the forecast editor, select the linear forecast type and then select the plot you added at step 1 as the input plot.

  <img src="./images/howto-forecast-time-series-select-linear.png" alt="Time series linear forecast selection" width=300/>
...
![Linear forecast plot](./images/howto-forecast-time-series-linear-plot.png)

You can find the values of the coefficients under the **Forecast Details** section of the forecast editor.

<img src="./images/howto-forecast-time-series-coefficients.png" alt="Linear forecast coefficients" width=300/>
...
![Training time range](./images/howto-forecast-time-series-time-range.png)
...
2. Set coefficients boundaries. In the **Coefficients** section of the editor, switch on the toggles for the coefficients you want to set boundaries on. In this example, setting a boundary on the slope coefficient of this forecast changes both coefficients.
  ...
  <img src="./images/howto-forecast-time-series-bounds.png" alt="Linear forecast coefficients bounds" width=300/>
...
3. Choose a loss definition. The default loss is the sum of squared differences, and the other options are the maximum absolute difference and the sum of absolute differences. When fitting the forecast to the training data, parameters will be selected to minimize the loss. Different types of loss will result in different forecasts. For more details refer to the [losses](#the-different-types-of-losses) section.
  ...
  <img src="./images/howto-forecast-time-series-loss.png" alt="Linear forecast loss" width=300/>
...
![Constant forecast](./images/howto-forecast-time-series-constant.png)
...
![Linear forecast](./images/howto-forecast-time-series-linear.png)
...
<img src="./images/howto-forecast-time-series-formula-exponential.png" alt="Formula exponential" width=100/>

* Sinusoidal formula

<img src="./images/howto-forecast-time-series-formula-sinusoidal.png" alt="Formula sinusoidal" width=170/>

![Formula forecast](./images/howto-forecast-time-series-formula.png)
...
<img src="./images/howto-forecast-time-series-formula-details.png" alt="Formula forecast details" width=300/>
...
* 1st order
  ...
  <img src="./images/howto-forecast-time-series-ode-1st-order.png" alt="ODE 1st order" width=200/>

* 2nd order

  <img src="./images/howto-forecast-time-series-ode-2nd-order.png" alt="ODE 2nd order" width=200/>

Examples:

* Exponential growth (λ>0) or decay (λ<0)

  <img src="./images/howto-forecast-time-series-ode-exponential.png" alt="ODE exponential" width=100/>

* Newton's 2nd law (`F=m*a`)

  <img src="./images/howto-forecast-time-series-ode-newton.png" alt="ODE newton" width=100/>

* Spring mass system, simple harmonic oscillator

  <img src="./images/howto-forecast-time-series-ode-spring-mass.png" alt="ODE spring mass" width=100/>
...
<img src="./images/howto-forecast-time-series-ode-expression.png" alt="ODE expression" width=300/>

In this example, we used an ODE forecast using the exponential growth equation.

![ODE forecast](./images/howto-forecast-time-series-ode.png)
...
<img src="./images/howto-forecast-time-series-arima-formula.png" alt="ARIMA formula" width=400/>

Where:
`yd`​ is `y` after differences (subtract consecutive values) have been taken `d` times.

![ARIMA forecast](./images/howto-forecast-time-series-arima.png)
...
To improve forecast accuracy when using the auto configuration, consider selecting the **Maximum likelihood** fit method.
...
<img src="./images/howto-forecast-time-series-squared-differences.png" alt="Sum of squared differences formula" width=400/>
...
<img src="./images/howto-forecast-time-series-absolute-differences.png" alt="Sum of absolute differences formula" width=400/>
...
<img src="./images/howto-forecast-time-series-maximum-absolute-difference.png" alt="The image shows the maximum absolute difference formula." width=400/>
