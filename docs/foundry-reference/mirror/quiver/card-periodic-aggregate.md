<!-- source: https://palantir.com/docs/foundry/quiver/card-periodic-aggregate/ · mirrored 2026-08-22 from Palantir Foundry docs -->
...
![Periodic aggregate example](./images/card-periodic-aggregate.png)
