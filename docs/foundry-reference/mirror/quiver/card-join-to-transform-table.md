<!-- source: https://palantir.com/docs/foundry/quiver/card-join-to-transform-table/ · mirrored 2026-08-05 from Palantir Foundry docs -->
...
![Transform table join](/docs/resources/foundry/quiver/transform-table-join.png)
