<!-- source: https://palantir.com/docs/foundry/quiver/card-join-to-transform-table/ · mirrored 2026-08-22 from Palantir Foundry docs -->
...
![Transform table join](./images/transform-table-join.png)
