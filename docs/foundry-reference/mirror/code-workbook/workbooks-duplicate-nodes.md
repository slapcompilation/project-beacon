<!-- source: https://palantir.com/docs/foundry/code-workbook/workbooks-duplicate-nodes/ · mirrored 2026-09-04 from Palantir Foundry docs -->
...
![Duplicate node in Code Workbook](./images/workbooks-duplicate-nodes.png)
...
![Select mode in Code Workbooks](./images/workbooks-duplicate-nodes-select-tool.png)
...
![Copy node to clipboard](./images/workbooks-copy-node-to-clipboard.png)
