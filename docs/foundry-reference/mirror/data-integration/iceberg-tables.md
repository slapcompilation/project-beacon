<!-- source: https://palantir.com/docs/foundry/data-integration/iceberg-tables/ · mirrored 2026-09-04 from Palantir Foundry docs -->
...
Foundry offers Iceberg both as managed tables via Foundry's Iceberg catalog and as [virtual tables](/docs/foundry/data-integration/virtual-tables/) via an external catalog. Refer to the [Iceberg tables](/docs/foundry/iceberg/overview/) section of the documentation for more details on Foundry Iceberg tables.
