<!-- source: https://palantir.com/docs/foundry/logic/evaluations-metrics-dashboard/ · mirrored 2026-08-18 from Palantir Foundry docs -->
...
![The aggregate metrics view in the evaluations metrics dashboard](./images/evals-logic-metric-dashboard.png)
...
![Access the metrics dashboard](./images/aip-evals-metrics-dashboard-access.png)
...
![Navigate from the metrics dashboard to the LLM trace viewer.](./images/aip-evals-metric-dashboard-debug-trace.gif)
