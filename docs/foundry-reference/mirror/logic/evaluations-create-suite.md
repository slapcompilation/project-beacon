<!-- source: https://palantir.com/docs/foundry/logic/evaluations-create-suite/ · mirrored 2026-08-18 from Palantir Foundry docs -->
...
![Evaluations side panel in an AIP Logic function.](./images/evals-logic-side-panel.png)
...
![Evaluations side panel in AIP Chatbot Studio.](./images/evals-chatbot-studio-side-panel.png)
...
![AIP Evals link in code repository.](./images/evals-code-repository-open-suite.png)
...
![Add target functions to your evaluation suite.](./images/aip-evals-add-execution-target.png)
...
![Configure test case parameters.](./images/aip-evals-create-suite-edit-parameters.png)
...
![Add object-set-backed test cases.](./images/aip-evals-create-suite-object-set-backed-test-cases.png)
...
![Edit object set properties.](./images/aip-evals-create-suite-edit-object-set-property.png)
...
![Select evaluators for your test cases.](./images/aip-evals-create-suite-evaluator-selection.png)
...
![Configure your evaluators.](./images/aip-evals-create-suite-evaluator-configuration.png)
...
![Configure your evaluators.](./images/aip-evals-create-suite-evaluator-configuration-objectives.png)
...
* **ROUGE score:** Measures how much of the wording in the actual (generated) text overlaps with the expected (target) text, particularly useful for tasks like summarization and translation. Returns `precision`, `recall`, and `f-measure`, each on a 0-1 scale where a higher score indicates closer match to the target.
