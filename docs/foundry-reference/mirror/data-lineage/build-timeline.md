<!-- source: https://palantir.com/docs/foundry/data-lineage/build-timeline/ · mirrored 2026-08-22 from Palantir Foundry docs -->
...
![View build timeline in Data Lineage](./images/build-timeline.png)
...
![View job details in build timeline](./images/job-details-window.png)
