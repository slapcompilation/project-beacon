<!-- source: https://palantir.com/docs/foundry/data-connection/listeners-event-processing/ · mirrored 2026-08-18 from Palantir Foundry docs -->
...
![Option to process streams in Automate.](./images/automate-streams.png)
...
![Build streaming pipelines in Pipeline Builder.](./images/event-stream-pipeline.png)
...
![Switch to archive mode on your event stream to access the underlying dataset.](./images/event-stream-archive.png)
