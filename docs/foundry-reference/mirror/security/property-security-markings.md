<!-- source: https://palantir.com/docs/foundry/security/property-security-markings/ · mirrored 2026-08-22 from Palantir Foundry docs -->
...
![An object property's security markings are displayed in a condensed pill and its expanded window.](./images/property-security-condensed-pill.png)
...
![The Show security markings toggle is enabled in the Property List, Object List, and Object Table widgets in Workshop.](./images/show-security-icon-in-widgets.png)
...
![A property's security markings expanded view is displayed in the Object List and Property List widgets in Workshop.](./images/property-security-object-property-list-widget.png)

To render the same expanded view in the Object Table widget, hover your cursor over a property value in the table.

![A property's security markings expanded view is displayed in the Object Table widget in Workshop.](./images/property-security-object-table.png)
...
![A struct property's security markings pill renders with the struct's singular value.](./images/property-security-marking-struct.png)
...
![An array property's security markings pills render with each array value.](./images/property-security-marking-array.png)
...
![A derived property's security markings pills differ at the property value level.](./images/property-security-marking-derived-property.png)
