<!-- source: https://palantir.com/docs/foundry/security/securing-a-business-application/ · mirrored 2026-09-04 from Palantir Foundry docs -->
...
![Ontology view](./images/secure-business-app-0.png)
...
![Object links in Ontology](./images/secure-business-app-1.png)
...
![Flight alert object with writeback dataset](./images/secure-business-app-2.png)
...
![Create restricted view](./images/secure-business-app-4.png)
...
![Create restricted view step 1](./images/secure-business-app-5.png)

![Create restricted view step 2](./images/secure-business-app-6.png)
...
![Configure a policy](./images/secure-business-app-7.png)
...
![Object type with restricted view](./images/secure-business-app-8.png)
...
![Access requirements](./images/secure-business-app-9.png)
...
![Granting roles](./images/secure-business-app-10.png)
