...
![Results View](./images/results_view.png)
...
![Column Options](./images/results_column_options.png)
...
<img src="./images/results_sorts.png" alt="Column Sorting" width="600"/>
...
<img src="./images/results_drag_column_header.png" alt="Reordering Columns" width="300"/>
...
<img src="./images/results_resize_column.png" alt="Resizing Columns" width="300"/>
...
<img src="./images/results_column_configurator.png" alt="Configuring Columns" height="450"/>
...
<img src="./images/results_column_menu.png" alt="Column Menu" width="300"/>
...
After selecting an object, the Selection Preview panel will open from the right. To close this panel for a full table view, use the "collapse" icon (<img src="./images/collapse-icon.png" alt="Collapse icon" width="25">) on the top left of the panel.

![Results Preview](./images/results_results_preview.png)
...
![Results Preview](./images/results_results_preview_multiselect.png)

To compare object views for two objects at once, select the top right dropdown and choose “Compare objects”.

![Results Comparison](./images/results_results_preview_compare.png)
...
![Time-dependent property in Results View](./images/results_time-dependent-property-hubble-results-view.png)

## Inline edits

![Inline edit in results view](./images/results_view_inline_edit.png)
