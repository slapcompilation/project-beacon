<!-- source: https://palantir.com/docs/foundry/manage-models/submit-model/ · mirrored 2026-09-04 from Palantir Foundry docs -->
...
<img src="./images/manage_submit-model-new.png" alt="Submission button" width="500">

Or, from an existing modeling objective, click **Submit model** at the top right of the models view.

<img src="./images/manage_submit-model-existing.png" alt="Submission button" width="500">
...
<img src="./images/manage_submit-model-popover.png" alt="Submission type" width="500">
