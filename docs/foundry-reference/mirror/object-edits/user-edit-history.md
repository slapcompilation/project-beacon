<!-- source: https://palantir.com/docs/foundry/object-edits/user-edit-history/ · mirrored 2026-09-04 from Palantir Foundry docs -->
...
![Track user edit history toggle](./images/track-user-edits-history.png)
...
* Once you enable the **Track user edit history**, it takes a few minutes to initialize. During this short period, users cannot perform actions on these objects.
...
![Disable user edit history toggle](./images/disable-edits-history.png)
