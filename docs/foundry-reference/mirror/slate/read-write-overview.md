<!-- source: https://palantir.com/docs/foundry/slate/read-write-overview/ · mirrored 2026-08-22 from Palantir Foundry docs -->
...
The [Ontology SDK (OSDK)](/docs/foundry/slate/concepts-osdk/) provides type-safe access to object types, link types, actions, and functions from within Slate's Functions editor.
...
Object sets, object context, Foundry Functions, the OSDK, and Actions require less setup but offer less flexibility.
