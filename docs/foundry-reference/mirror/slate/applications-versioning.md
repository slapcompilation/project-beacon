<!-- source: https://palantir.com/docs/foundry/slate/applications-versioning/ · mirrored 2026-08-22 from Palantir Foundry docs -->
...
![A Demo Slate application is on version 15. The version number is highlighted with a red border. ](./images/application-version-number.png)
...
![Version dialog](./images/version-publish.png)
...
![Version dialog publish latest](./images/version-publish-latest.png)

## View versions

To open a version for viewing, select the three dots `...` to the right of the version name and select **View this version**.

![A pop-up appears that allows you to choose to view the given version.](./images/view-this-version.png)
...
![Unpublished warning](./images/version-warning-banner.png)
...
![A pop-up appears that allows you to choose to revert to the given version.](./images/revert-to-version.png)
...
![A pop-up appears that allows you to choose to compare a given version to the latest version.](./images/compare-version.png)
...
![The version comparison screen, comparing V1 and V4 of the Slate Test Docs application. Changes are highlighted in red in the V1 view and in green in the V4 view. ](./images/compare-versions-diff.png)
...
![Version dialog tagging](./images/version-publish-tags.png)
