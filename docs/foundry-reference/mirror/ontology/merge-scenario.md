<!-- source: https://palantir.com/docs/foundry/ontology/merge-scenario/ · mirrored 2026-08-22 from Palantir Foundry docs -->
...
2. Within the **Scenario** tab, define the scope of your scenario edits by adding the relevant **Object types** and **Link types**. <br><br>
   ![Create a new action type dialog showing the Scenario tab with Object type and Link type selection fields for configuring a merge action.](./images/merge-scenario-action.png) <br><br>
...
![Scenario parameter in Apply Scenario rule in Ontology Manager.](./images/merge-scenario-parameter.png)
