<!-- source: https://palantir.com/docs/foundry/ontology/persisted-scenario/ · mirrored 2026-08-04 from Palantir Foundry docs -->
...
2. Follow the configuration wizard. At step 3 (**Properties**), choose to **Add** an interface, then search for the **Ontology Scenario** interface. Ensure that **Scenario Reference** is mapped to the primary key of your object type, then complete the remaining steps. <br><br>
   ![Persist scenario metadata in the Ontology.](/docs/resources/foundry/ontology/persist-scenario-metadata-ontology-manager.png) <br><br>
...
2. Within the **Create Object** action configuration, add an additional parameter of type **String**. In the **Constraints** card, set the value type to **Scenario Reference Value**. Then disable the **Visibility** toggle to hide the parameter from end users. <br><br>
   ![Create persist scenario action in the Ontology.](/docs/resources/foundry/ontology/persist-scenario-create-scenario-action-configuration.png) <br><br>
...
3. In the **Rules** tab of the Action configuration page, ensure the **Unique ID** property is mapped to the new **Scenario Reference** parameter. <br><br>
   ![Create persist scenario action property mapping in the Ontology.](/docs/resources/foundry/ontology/persist-scenario-create-scenario-action-property-mapping-redacted.png) <br><br>
...
3. In the **Default Value** configuration, set the **Scenario Reference** parameter to be populated by the Active Scenario variable generated by the **Scenario Manager** widget. <br><br>
   ![Persist scenario button parameter default.](/docs/resources/foundry/ontology/persist-scenario-button-parameter-default.png) <br><br>
...
3. Set the **Scenario Object Type** as the data source for the newly added widget. <br><br>
   ![Persist scenario object list configuration in the Workshop.](/docs/resources/foundry/ontology/persist-scenario-workshop-object-list-widget.png) <br><br>
...
4. Replace the **Active Scenario** variable with an **Object-backed scenario** variable, and set its value to the **Active Object** from the **Object List** widget. You should update the variable selection in other widgets. <br><br>
   ![Persist scenario object backed scenario variable in the Workshop.](/docs/resources/foundry/ontology/persist-scenario-object-backed-scenario-variable.png) <br><br>
