...
`docs/foundry-reference/readings/automate.md`, which shares the fallback page. So nothing
...
- `docs/foundry-reference/readings/automate.md` — the notification effect is one of
