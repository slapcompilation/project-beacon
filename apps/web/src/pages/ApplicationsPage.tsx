...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    surfaces: [
      ...
      { label: 'Team',         path: '/eye?panel=team',        icon: 'people',      desc: 'Per-member waste + benchmarking' },
      { label: 'CPOR',         path: '/eye?panel=cpor',        icon: 'bank-account',desc: 'Cost per occupied room' },
      { label: 'Budget',       path: '/eye?panel=budget',      icon: 'bank-account',desc: 'Spend vs allocation by category' },
      { label: 'F&B Intel',    path: '/eye?panel=fb',          icon: 'shop',        desc: 'Dish COGS + theft variance' },
      { label: 'GL Export',    path: '/eye?panel=gl',          icon: 'th',          desc: 'Map + export to the ledger' },
